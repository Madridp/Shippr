    ...
    <div class="col-xl-6 col-sm-12">
      <div class="pvr-wrapper">
          ...
          <div class="text-center">
            ...
            <h3><?php echo 'Gracias por tu pago '.get_user_name(); ?></h3>
            <p>¡Listo!, sigue disfrutando de los beneficios de usar Shippr Envíos <strong><?php echo $d->t->title; ?></strong></p>
          </div>
          <div class="text-center py-5">
            <img src="<?php echo URL.IMG.'va-transaction-approved.svg'; ?>" alt="<?php echo $d->title; ?>" style="width: 250px;">
          </div>
