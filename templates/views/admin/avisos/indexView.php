	...
	<div class="row">
		<div class="col-xl-12">
          ...
          <div class="button-group mb-3 text-right">
            <button class="btn btn-primary do_u_create_direccion_modal"><i class="fas fa-plus"></i> Agregar dirección</button>
          </div>
            ...
            <img src="<?php echo IMG.'va-addresses.svg'; ?>" alt="No hay registros" class="img-fluid" style="width: 150px;">
            <h4 class="mt-3 mb-2"><b>Upps... no hay avisos registrados</b></h4>
            <button class="btn btn-primary"><i class="fas fa-plus"></i> Agregar nuevo aviso</button>
          </div>
					<?php endif ?>
				</div>
			</div>
