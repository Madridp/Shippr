  ...
  <div class="row">
    ...
    <div class="col-xl-6 col-sm-12">
      <div class="pvr-wrapper">
          ...
          <p>Aun debes realizar la transferencia bancaria a nuestras cuentas y enviar el comprobante a <?php echo get_smtp_email() ?> con el asunto <?php echo '"Comprobante de pago compra #'.$d->v->folio.'".'; ?></p>
