  ...
  <div class="auth_v2_box">
    ...
    <form method="POST" id="login-form">
      <div class="form-group">
        <label>Usuario</label><input class="form-control" placeholder="Nombre de usuario" type="text" name="usuario">
        <div class="pre-icon material-icons">account_circle</div>
      </div>
      <div class="form-group">
        <label>Password</label><input class="form-control" placeholder="Ingresa tu contraseña" type="password" name="password">
        <div class="pre-icon material-icons">fingerprint</div>
      </div>
      <div class="buttons-w">
        <input type="submit" class="btn btn-primary " value="Ingresar" name="login" />
      </div>
      <div class="col-lg-12 m-t-20 p-l-0">
        <small><a href="login/recuperar-contrasena">¿Olvidaste tu contraseña?</a></small>
        <small class="d-block">¿No tienes cuenta? <a href="registro">Regístrate aquí</a></small>
      </div>
    </form>
  </div>
</div>
