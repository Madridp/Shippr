      ...
      <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" width="100%" style="max-width: 700px;">
                  ...
                  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="font-size: 14px; text-align: left;">
                    <tr>
                      <td style="text-align: left; padding: 0 10px;">
                        <img src="<?php echo URL . IMG . get_sitelogo(); ?>" width="150px" height="" alt="alt_text" border="0" align="center" style="width: 100%; max-width: 150px; background: #ffffff; font-family: sans-serif; font-size: 15px; line-height: 140%; color: #555555;">
                      </td>
                    </tr>                                        
                  </table>
                </td>
                    ...
                    <tr>
                      <td style="text-align: left; padding: 0 10px; font-family: sans-serif;">
                        ...
                        *|JS_TITLE|*</h1>
                        ...
                        <p style="font-size: 16px; line-height: 28px; color: black;">*|JS_BODY|*</p>

                        <h3><?php echo (isset($this->data['prueba']) ? $this->data['prueba'] : 'No está seteada!'); ?></h3>
        ...
        <td align="center" height="100%" valign="top" width="100%" style="padding: 40px 10px 40px 10px; background-color: #2f2f2f;">
          ...
          line-height: 26px; font-weight: 500; color: white; margin-bottom: 20px;">
            ...
            Este es un email generado de forma automática.
          </p>
        </td>
        </tr>
      </table>
